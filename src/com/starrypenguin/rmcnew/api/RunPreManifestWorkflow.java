 ...
 * RunPreManifest
 * <p/>
 * Java library API for automated run of PreManifest workflow
 * <p/>
 * Author: Richard Scott McNew
 */
public class RunPreManifestWorkflow extends RunAbstractWorkflow {

    public RunPreManifestWorkflow(File inputManifest,
                                  File processedManifest) throws IOException, SheetNotFoundException {

        super(inputManifest, processedManifest, new PreManifestController());
    }
}
